...
{
  "$end", "error", "$undefined", "OPEN_PARA", "CLOSE_PARA", "OPEN_BRA",
  "CLOSE_BRA", "MAIN", "WHILE", "EXIT", "ID", "SE", "C", "INT", "FLOAT",
  "CHAR", "DOUBLE", "'\\n'", "$accept", "START", "S1", "S", "L1", "L2",
  "L3", "L4", "E", YY_NULLPTR
};
#endif
...
static const yytype_int16 yytoknum[] =
{
     ...
     265,   266,   267,   268,   269,   270,   271,    10
};
# endif
...
{
     -18,     0,   -18,   -18,    -3,     1,   -18,     2,    15,    23,
      24,    13,   -18,    29,    30,   -18,    -1,   -18,     7,   -18,
      12,   -18,    20,   -18,   -18,    34,    35,   -18,    31,   -18,
      32,   -18,    33,   -18,    36,   -18,   -18,   -18,   -18,   -18,
     -18,   -18
};
...
{
       3,     0,     1,    12,     0,     0,    13,     0,     0,     0,
       0,     0,     5,     0,     0,    15,     0,    17,     0,    19,
       0,    21,     0,     2,     4,     0,     0,    22,     0,     6,
       0,     7,     0,     8,     0,     9,    10,    11,    14,    16,
      18,    20
};
...
{
     -18,   -18,   -18,    28,   -18,   -18,   -18,   -18,   -17
};

  /* YYDEFGOTO[NTERM-NUM].  */
static const yytype_int8 yydefgoto[] =
{
      -1,     1,    11,    12,    16,    18,    20,    22,    29
};
...
{
       2,    31,    13,    33,     3,    35,    14,     4,     5,     6,
      27,    28,    15,     7,     8,     9,    10,     3,    27,    30,
       4,     5,     6,    27,    32,    17,     7,     8,     9,    10,
      23,    27,    34,    19,    21,    25,    26,    36,    37,    24,
       0,    38,    39,    40,     0,     0,    41
};

static const yytype_int8 yycheck[] =
{
       0,    18,     5,    20,     4,    22,     5,     7,     8,     9,
      11,    12,    10,    13,    14,    15,    16,     4,    11,    12,
       7,     8,     9,    11,    12,    10,    13,    14,    15,    16,
      17,    11,    12,    10,    10,     6,     6,     3,     3,    11,
      -1,    10,    10,    10,    -1,    -1,    10
};
...
{
       0,    19,     0,     4,     7,     8,     9,    13,    14,    15,
      16,    20,    21,     5,     5,    10,    22,    10,    23,    10,
      24,    10,    25,    17,    21,     6,     6,    11,    12,    26,
      12,    26,    12,    26,    12,    26,     3,     3,    10,    10,
      10,    10
};
...
yyreduce:
  ...
  switch (yyn)
    {
  case 10:
#line 47 "BT18CSE040.y"
                                        {level++;}
#line 1375 "y.tab.c"
    break;

  case 11:
#line 48 "BT18CSE040.y"
                                         {level++;}
#line 1381 "y.tab.c"
    break;

  case 12:
#line 49 "BT18CSE040.y"
                 {isValid();level--;}
#line 1387 "y.tab.c"
    break;

  case 13:
#line 50 "BT18CSE040.y"
           {printf("EXITING...\n\n");print();exit(EXIT_SUCCESS);}
#line 1393 "y.tab.c"
    break;

  case 14:
#line 52 "BT18CSE040.y"
          {strcpy(temp,(char *)(yyvsp[0].sIndex)); insert(0);}
#line 1399 "y.tab.c"
    break;

  case 15:
#line 53 "BT18CSE040.y"
         {strcpy(temp,(char *)(yyvsp[0].sIndex)); insert(0);}
#line 1405 "y.tab.c"
    break;

  case 16:
#line 55 "BT18CSE040.y"
          {strcpy(temp,(char *)(yyvsp[0].sIndex)); insert(1);}
#line 1411 "y.tab.c"
    break;

  case 17:
#line 56 "BT18CSE040.y"
         {strcpy(temp,(char *)(yyvsp[0].sIndex)); insert(1);}
#line 1417 "y.tab.c"
    break;

  case 18:
#line 58 "BT18CSE040.y"
          {strcpy(temp,(char *)(yyvsp[0].sIndex)); insert(2);}
#line 1423 "y.tab.c"
    break;

  case 19:
#line 59 "BT18CSE040.y"
         {strcpy(temp,(char *)(yyvsp[0].sIndex)); insert(2);}
#line 1429 "y.tab.c"
    break;

  case 20:
#line 61 "BT18CSE040.y"
          {strcpy(temp,(char *)(yyvsp[0].sIndex)); insert(3);}
#line 1435 "y.tab.c"
    break;

  case 21:
#line 62 "BT18CSE040.y"
         {strcpy(temp,(char *)(yyvsp[0].sIndex)); insert(3);}
#line 1441 "y.tab.c"
    break;
